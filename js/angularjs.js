...
(function(z) {
  ...
  function ve(a) {
    if (D(a))
      w(a.objectMaxDepth) &&
        (Xb.objectMaxDepth = Yb(a.objectMaxDepth) ? a.objectMaxDepth : NaN), w(
        ...
        function tc(a, b, d, e, f) {
          ...
          switch (a.nodeType) {
            case 1:
              ...
              if (C(g) && "" !== g)
                for (; (a = k.exec(g)); )
                  (n = xa(a[2])), Y(b, n, "C", e, f) &&
                    (d[n] = V(a[3])), (g = g.substr(a.index + a[0].length));
              break;
            case Pa:
              na(b, a.nodeValue);
              break;
          ...
          for (
            ...
            if ((O = u.scope))
              u.templateUrl ||
                (D(O)
                  ...
                  : ba("new/isolated scope", s, u, y)), (t = t || u);
            Q = u.name;
            if (
              !ma &&
            ...
            if ((O = u.transclude))
              if (
                ...
                (N = !0), (n = u.priority), (M = y), (y = d.$$element = x(
                  ...
                  r(y.contents(), function(a) {
                    ...
                    b
                      ? (
                          (F[b] = !0),
                          (ka[b] =
                            ka[b] || z.document.createDocumentFragment()),
                          ka[b].appendChild(a)
                        )
                      : M.appendChild(a);
                  });
            ...
            if (u.templateUrl)
              (P = !0), ba("template", v, u, y), (v = u), u.replace &&
                (g = u), (p = ha(
                  ...
                  pre: function(a, c, f) {
                    ...
                    p &&
                      (
                        (f[e] = p(a)),
                        ((c[e] || (c[e] = [])).$$inter = !0),
                        ((f.$$observers && f.$$observers[e].$$scope) || a)
    ...
    this.$get = [
      ...
      function(b) {
        ...
        return function(c, e, f, g) {
          ...
          if (f)
            return (f = (H(c) ? c[c.length - 1] : c)
              .prototype), (k = Object.create(f || null)), l &&
              d(e, l, k, h || c.name), S(
              function() {
    ...
    this.$get = [
      ...
      function(d, c, e) {
        ...
        function h(f, h, n, p) {
          function v(a) {
            try {
              return (a = n && !r ? e.getTrusted(n, a) : e.valueOf(a)), p &&
              !w(a)
                ? a
                : jc(a);
            } catch (b) {
          ...
          for (
            ...
            if (
              ...
              J !== q && M.push(g(f.substring(J, q))), (J = f.substring(
                q + l,
                y
              )), I.push(J), (J = y + m), L.push(M.length), M.push("");
            else {
  ...
  function Dd(a, b, d) {
    ...
    for (
      ...
      (c[e] = decodeURIComponent(c[e])), d &&
        (c[e] = c[e].replace(/\//g, "%2F"));
    d = c.join("/");
    b.$$path = d;
      ...
      function(f, g, k) {
        ...
        m.prototype = {
            ...
            function c(a) {
              ...
              if (!A(e)) {
                if (D(e))
                  if (za(e))
                    for (
                      f !== n && ((f = n), (t = f.length = 0), l++), a =
                        e.length, t !== a && (l++, (f.length = t = a)), b = 0;
                      b < a;
                      b++
                    )
          ...
          $on: function(a, b) {
            ...
            var d = this;
            do
              d.$$listenerCount[a] || (d.$$listenerCount[a] = 0), d
                .$$listenerCount[a]++;
            while ((d = d.$parent));
            var e = this;
            return function() {
      ...
      attr: function(a, b, d) {
        ...
        if (c !== Pa && 2 !== c && 8 !== c && a.getAttribute) {
          ...
          if (w(d))
            ...
            return (a = a.getAttribute(b)), e && null !== a && (a = c), null ===
            a
              ? void 0
              : a;
        }
  ...
  Ld.prototype = {
    compile: function(a) {
      ...
      this.stage = "assign";
      if ((c = Kd(a)))
        (this.state.computing = "assign"), (d = this.nextId()), this.recurse(
          c,
          d
        ), this.return_(d), (d =
  ...
  Md.prototype = {
    ...
    recurse: function(a, b, d) {
      ...
      switch (a.type) {
        ...
        case q.BinaryExpression:
          return (c = this.recurse(a.left)), (e = this.recurse(a.right)), this[
            "binary" + a.operator
          ](c, e, b);
        case q.LogicalExpression:
          return (c = this.recurse(a.left)), (e = this.recurse(a.right)), this[
        ...
        case q.AssignmentExpression:
          return (c = this.recurse(a.left, !0, 1)), (e = this.recurse(
            a.right
          )), function(a, d, f, g) {
            var p = c(a, d, f, g);
            a = e(a, d, f, g);
  ...
  Sb.prototype = {
    ...
    $commitViewValue: function() {
      ...
      if (
        ...
        this.$$updateEmptyClasses(a), (this.$$lastCommittedViewValue = a), this
